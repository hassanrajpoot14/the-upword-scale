export const CASE_STUDIES = [
  {
    ...
    heroMetric: { value: "74%", label: "Ticket Deflection" },
    ...
    architecture: [
      { id: "edge", label: "Dashboard Embed", detail: "In-product agent UI" },
      { id: "app", label: "React Client", detail: "Realtime chat surface" },
      { id: "api", label: "RAG Orchestrator", detail: "GPT-4o + tools" },
      { id: "data", label: "Pinecone + Postgres", detail: "Docs + ticket state" },
    ],
    results: [
  ...
  },
  {
    ...
    problem:
      "3.8s loads and failing Core Web Vitals draining ~$1.2M/yr in abandoned carts.",
    heroMetric: { value: "+38%", label: "Conversion Rate" },
    liveUrl: "https://vertex.shop",
    challenge:
    ...
    architecture: [
      { id: "edge", label: "Edge CDN", detail: "Global cache + ISR" },
      { id: "app", label: "Next.js 16", detail: "RSC + streaming" },
      { id: "api", label: "Storefront API", detail: "Shopify headless" },
      { id: "data", label: "Catalog ISR", detail: "3,200 product pages" },
    ],
    results: [
  ...
  },
  {
    ...
    heroMetric: { value: "+218%", label: "Organic Traffic" },
    liveUrl: "https://medral.health",
    challenge:
    ...
    architecture: [
      { id: "edge", label: "Crawl Surface", detail: "Technical SEO fixes" },
      { id: "app", label: "Next.js Hub", detail: "Pillar + cluster pages" },
      { id: "api", label: "Schema Graph", detail: "Entity markup" },
      { id: "data", label: "Keyword Map", detail: "1,400 long-tails" },
    ],
    results: [
  ...
  },
  {
    ...
    problem:
      "Mid-market perception capped budgets under $10K with inconsistent brand signals.",
    heroMetric: { value: "3.2×", label: "Avg. Deal Size" },
    liveUrl: "https://arkade.studio",
    challenge:
    ...
    architecture: [
      { id: "edge", label: "Brand Site", detail: "Premium web presence" },
      { id: "app", label: "React + R3F", detail: "Immersive hero system" },
      { id: "api", label: "CMS Content", detail: "Case + service pages" },
      { id: "data", label: "Design Tokens", detail: "Type + color system" },
    ],
    results: [
  ...
  },
  {
    ...
    heroMetric: { value: "50K+", label: "Users in 90 Days" },
    liveUrl: "https://trailr.app",
    challenge:
    ...
    architecture: [
      { id: "edge", label: "App Stores", detail: "iOS + Android" },
      { id: "app", label: "React Native", detail: "Expo + Mapbox" },
      { id: "api", label: "Node API", detail: "Auth + social feed" },
      { id: "data", label: "Postgres", detail: "Users + trails" },
    ],
    results: [
  ...
  },
  {
    ...
    heroMetric: { value: "<200ms", label: "Risk Score Latency" },
    liveUrl: "https://synapse.finance",
    challenge:
    ...
    architecture: [
      { id: "edge", label: "Ingest Bus", detail: "Plaid + Stripe hooks" },
      { id: "app", label: "Risk Console", detail: "Analyst UI" },
      { id: "api", label: "SageMaker LLM", detail: "Fine-tuned scoring" },
      { id: "data", label: "Vector Store", detail: "Anomaly similarity" },
    ],
    results: [
